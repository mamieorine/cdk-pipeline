...
class CdkPipelineStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const stage = new MyPipelineAppStage(this, "customAuthlambda", {
      env: { account: "975050056288", region: "eu-west-2" }
    })
    const sourceStage = pipeline.addStage(stage, {
      post: [
        new ShellStep('Install dependenc', {
          commands: ['cd lib/lambda/customAuthorization', 'npm ci'],
        }),
      ],
    });
  }
